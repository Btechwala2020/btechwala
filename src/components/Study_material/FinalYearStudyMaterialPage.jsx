...
function FinalYearStudyMaterialPage() {
    ...
    const studyMaterials = [
        ...
        },
        {
            ...
            downloadUrl: "/ImportantTopic/Fourthyear",
            fileType: "PDF"
        },
        {
            title: "Latest Quantum",
            description: "Latest Quantum  for Final Year B.Tech students",
            imageUrl: "Latest Quantum",
            downloadUrl: "/FourthYearQuantum",
            fileType: "ZIP"
        },
        {
...
export default FinalYearStudyMaterialPage;