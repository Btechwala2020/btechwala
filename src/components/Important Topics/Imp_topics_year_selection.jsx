...
function Imp_topics_year_selection() {
  ...
  const yearData = [
    {
      ...
      link: '/important-topics/first-year'
    },
    {
      icon: twoIcon,
      title: 'Btech',
      description: 'Second year',
      link: '/important-topics/second-year'
    },
    {
      icon: threeIcon,
      title: 'Btech',
      description: 'Third year',
      link: '/important-topics/third-year'
    },
    {
      icon: fourIcon,
      title: 'Btech',
      description: 'Fourth year',
      link: '/important-topics/fourth-year'
    }
  ]
    ...
    <>
      ...
      <div className='year-container'>
        <div id="titlee" className="title1">
          <h1>Choose Important Topics <span>for BTECH</span></h1>
        </div>
...
export default Imp_topics_year_selection